                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Manage your application settings and branding</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Textarea
                                ...
                                :disabled="form.processing"
                            />
                            <p v-if="form.errors.app_description" class="text-sm text-red-600">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                >
                                    <span class="text-2xl font-bold text-white">TF</span>
                                </div>
                                <div class="flex-1">
                                    <input
                                        id="app_icon"
                            ...
                            <p v-if="form.errors.app_icon" class="text-sm text-red-600">
